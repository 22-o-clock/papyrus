...
from .use_cases.chatbot import ChatbotUseCases
...
class ChatBot(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot, session_factory: async_sessionmaker[AsyncSession]) -> None:
        self.use_cases = ChatbotUseCases(bot, session_factory)

    @commands.Cog.listener()
    async def on_ready(self) -> None:
        await self.use_cases.on_ready()

    @commands.Cog.listener()
    async def on_message(self, message: Message) -> None:
        await self.use_cases.on_message(message)

    @commands.Cog.listener()
    async def on_message_delete(self, message: Message) -> None:
        await self.use_cases.on_message_delete(message)

    @commands.Cog.listener()
    async def on_message_edit(self, before: Message, after: Message) -> None:
        await self.use_cases.on_message_edit(before, after)
    ...
    async def show_chatbot_role(self, interaction: discord.Interaction) -> None:
        await self.use_cases.settings_use_cases.show_role(interaction)
    ...
    async def set_chatbot_conversation_reset_minutes(
        ...
        await self.use_cases.settings_use_cases.set_conversation_reset_minutes(interaction, minutes)
    ...
    async def set_chatbot_question_wait(
        ...
        await self.use_cases.settings_use_cases.set_question_wait(interaction, minimum_minutes, maximum_minutes)
    ...
    async def set_chatbot_role(self, interaction: discord.Interaction, role: ChannelRole) -> None:
        await self.use_cases.settings_use_cases.set_role(interaction, role)
    ...
    async def reset_chatbot_role(self, interaction: discord.Interaction) -> None:
        await self.use_cases.settings_use_cases.reset_role(interaction)
    ...
    async def set_chatbot_shadow_mode(self, interaction: discord.Interaction, *, enabled: bool) -> None:
        await self.use_cases.settings_use_cases.set_shadow_mode(interaction, enabled=enabled)
    ...
    async def export_chatbot_shadow_candidates(self, interaction: discord.Interaction) -> None:
        await self.use_cases.export_chatbot_shadow_candidates(interaction)
    ...
    async def import_chatbot_shadow_evaluations(
        ...
        await self.use_cases.import_chatbot_shadow_evaluations(interaction, attachment)
    ...
    async def export_chatbot_member_aliases(self, interaction: discord.Interaction) -> None:
        await self.use_cases.export_chatbot_member_aliases(interaction)
    ...
    async def import_chatbot_member_aliases(
        ...
        await self.use_cases.import_chatbot_member_aliases(interaction, attachment)
    ...
    async def export_chatbot_memories(self, interaction: discord.Interaction) -> None:
        await self.use_cases.export_chatbot_memories(interaction)
    ...
    async def import_chatbot_memories(
        ...
        await self.use_cases.import_chatbot_memories(interaction, attachment)
